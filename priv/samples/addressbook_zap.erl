-file("addressbook.zap", 1).

%% This file was generated 2014-05-27 10:20:43 UTC by ezap 0.2.
%% https://github.com/zap-proto/erlang
-module(addressbook_zap).
...
'11435534567900897652'() ->
    #schema_node{module = addressbook_zap, name = root, id = 11435534567900897652, scope = 0,
		 src = <<"addressbook.zap">>, annotations = [{13386661402618388268, <<"addressbook">>}],
		 kind = file,
		 nodes =
...
'17957216978475721012'() ->
    #schema_node{module = addressbook_zap, name = 'AddressBook', id = 17957216978475721012,
		 scope = 11435534567900897652, src = <<"addressbook.zap:AddressBook">>,
		 kind =
...
'10988939875124296728'() ->
    #schema_node{module = addressbook_zap, name = 'Person', id = 10988939875124296728,
		 scope = 11435534567900897652, src = <<"addressbook.zap:Person">>,
		 kind =
...
'9317543775882349264'() ->
    #schema_node{module = addressbook_zap, name = ['Person', 'PhoneNumber'], id = 9317543775882349264,
		 scope = 10988939875124296728, src = <<"addressbook.zap:Person.PhoneNumber">>,
		 kind =
...
'10511609358742521391'() ->
    #schema_node{module = addressbook_zap, name = ['Person', 'PhoneNumber', 'Type'],
		 id = 10511609358742521391, scope = 9317543775882349264,
		 src = <<"addressbook.zap:Person.PhoneNumber.Type">>,
		 kind = #enum{values = [{0, mobile}, {1, home}, {2, work}]}}.

'13477914502553102653'() ->
    #schema_node{module = addressbook_zap, name = ['Person', employment], id = 13477914502553102653,
		 scope = 10988939875124296728, src = <<"addressbook.zap:Person.employment">>,
		 kind =
