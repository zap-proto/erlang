-file("calculator.zap", 1).

%% This file was generated 2014-05-15 13:58:14 UTC by ezap 0.2.
%% https://github.com/zap-proto/erlang
-module(calculator_zap).
...
'9589583151133806923'() ->
    #schema_node{module = calculator_zap, name = root, id = 9589583151133806923, scope = 0,
		 src = <<"calculator.zap">>, kind = file,
		 nodes =
...
'10923537602090224694'() ->
    #schema_node{module = calculator_zap, name = 'Calculator', id = 10923537602090224694,
		 scope = 9589583151133806923, src = <<"calculator.zap:Calculator">>,
		 kind =
		     #interface{extends = [],
				methods =
...
'15292209801435843861'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Expression'],
		 id = 15292209801435843861, scope = 10923537602090224694,
		 src = <<"calculator.zap:Calculator.Expression">>,
		 kind =
...
'15678475764784139622'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Expression', call],
		 id = 15678475764784139622, scope = 15292209801435843861,
		 src = <<"calculator.zap:Calculator.Expression.call">>,
		 kind =
...
'14116142932258867410'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Value'], id = 14116142932258867410,
		 scope = 10923537602090224694, src = <<"calculator.zap:Calculator.Value">>,
		 kind =
		     #interface{extends = [],
				methods =
...
'16626840274624768034'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Value', [read, '$Results']],
		 id = 16626840274624768034, scope = 0, src = <<"calculator.zap:Calculator.Value.read$Results">>,
		 kind =
...
'15227555948799047000'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Value', [read, '$Params']],
		 id = 15227555948799047000, scope = 0, src = <<"calculator.zap:Calculator.Value.read$Params">>,
		 kind = #struct{dsize = 0, psize = 0, esize = empty, union_field = none, fields = []}}.

'17143016017778443156'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Function'],
		 id = 17143016017778443156, scope = 10923537602090224694,
		 src = <<"calculator.zap:Calculator.Function">>,
		 kind =
		     #interface{extends = [],
				methods =
...
'13898297529173597869'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Function', [call, '$Results']],
		 id = 13898297529173597869, scope = 0, src = <<"calculator.zap:Calculator.Function.call$Results">>,
		 kind =
		     #struct{dsize = 1, psize = 0, esize = eightBytes, union_field = none,
			     fields =
				 [#field{id = 0, name = value,
...
'12795114529121400599'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Function', [call, '$Params']],
		 id = 12795114529121400599, scope = 0, src = <<"calculator.zap:Calculator.Function.call$Params">>,
		 kind =
...
'9769222902479511526'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', 'Operator'], id = 9769222902479511526,
		 scope = 10923537602090224694, src = <<"calculator.zap:Calculator.Operator">>,
		 kind = #enum{values = [{0, add}, {1, subtract}, {2, multiply}, {3, divide}]}}.

'15100494197045627936'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', [getOperator, '$Results']],
		 id = 15100494197045627936, scope = 0, src = <<"calculator.zap:Calculator.getOperator$Results">>,
		 kind =
		     #struct{dsize = 0, psize = 1, esize = pointer, union_field = none,
			     fields =
...
'9983863225544066352'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', [getOperator, '$Params']],
		 id = 9983863225544066352, scope = 0, src = <<"calculator.zap:Calculator.getOperator$Params">>,
		 kind =
...
'10170522573213587144'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', [defFunction, '$Results']],
		 id = 10170522573213587144, scope = 0, src = <<"calculator.zap:Calculator.defFunction$Results">>,
		 kind =
		     #struct{dsize = 0, psize = 1, esize = pointer, union_field = none,
			     fields =
				 [#field{id = 0, name = func,
...
'17476144387247758473'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', [defFunction, '$Params']],
		 id = 17476144387247758473, scope = 0, src = <<"calculator.zap:Calculator.defFunction$Params">>,
		 kind =
...
'9345430975918089745'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', [evaluate, '$Results']],
		 id = 9345430975918089745, scope = 0, src = <<"calculator.zap:Calculator.evaluate$Results">>,
		 kind =
		     #struct{dsize = 0, psize = 1, esize = pointer, union_field = none,
			     fields =
				 [#field{id = 0, name = value,
...
'13478898619544909524'() ->
    #schema_node{module = calculator_zap, name = ['Calculator', [evaluate, '$Params']],
		 id = 13478898619544909524, scope = 0, src = <<"calculator.zap:Calculator.evaluate$Params">>,
		 kind =
		     #struct{dsize = 0, psize = 1, esize = pointer, union_field = none,
			     fields =
