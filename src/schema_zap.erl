...
%% This file was generated 2014-05-31 07:56:29 UTC by ezap 0.2.
...
-import('c++_zap', ['13386661402618388268'/0]).
...
-type({{record, schema_node},
	...
	{typed_record_field, {record_field, 10, {atom, 10, name}},
	 {type, 10, union,
	  [{atom, 10, undefined}, {remote_type, 10, [{atom, 10, ezap}, {atom, 10, type_name}, []]}]}},
	{typed_record_field, {record_field, 11, {atom, 11, id}, {integer, 11, 0}},
	 {remote_type, 11, [{atom, 11, ezap}, {atom, 11, type_id}, []]}},
	{typed_record_field, {record_field, 12, {atom, 12, src}, {bin, 12, []}},
	 {remote_type, 12, [{atom, 12, ezap}, {atom, 12, text}, []]}},
	{typed_record_field, {record_field, 13, {atom, 13, kind}, {atom, 13, file}},
	 {remote_type, 13, [{atom, 13, ezap}, {atom, 13, schema_kind}, []]}},
	...
	{typed_record_field, {record_field, 15, {atom, 15, nodes}, {nil, 15}},
	 {remote_type, 15, [{atom, 15, ezap}, {atom, 15, schema_nodes}, []]}},
	{typed_record_field, {record_field, 16, {atom, 16, scope}, {integer, 16, 0}},
	 {remote_type, 16, [{atom, 16, ezap}, {atom, 16, type_id}, []]}}],
       []}).
...
-type({{record, enum},
	 ...
	 {remote_type, 30, [{atom, 30, ezap}, {atom, 30, enum_values}, []]}}],
       []}).
...
-type({{record, data},
	...
	{typed_record_field, {record_field, 67, {atom, 67, align}, {integer, 67, 0}},
	 {remote_type, 67, [{atom, 67, ezap}, {atom, 67, bit_count}, []]}},
	{typed_record_field, {record_field, 68, {atom, 68, default}},
	 {type, 68, union,
	  [{atom, 68, undefined}, {remote_type, 68, [{atom, 68, ezap}, {atom, 68, value}, []]}]}}],
       []}).
...
-type({{record, group},
	 ...
	 {remote_type, 72, [{atom, 72, ezap}, {atom, 72, type_id}, []]}}],
       []}).
...
'12195682960037147353'() ->
    #schema_node{module = schema_zap, name = root, id = 12195682960037147353, scope = 0,
		 src = <<"schema.zap">>, annotations = [{13386661402618388268, <<"zap::schema">>}], kind = file,
		 nodes =
...
'13818529054586492878'() ->
    #schema_node{module = schema_zap, name = 'CodeGeneratorRequest', id = 13818529054586492878,
		 scope = 12195682960037147353, src = <<"schema.zap:CodeGeneratorRequest">>,
		 kind =
...
'14981803260258615394'() ->
    #schema_node{module = schema_zap, name = ['CodeGeneratorRequest', 'RequestedFile'],
		 id = 14981803260258615394, scope = 13818529054586492878,
		 src = <<"schema.zap:CodeGeneratorRequest.RequestedFile">>,
		 kind =
...
'12560611460656617445'() ->
    #schema_node{module = schema_zap, name = ['CodeGeneratorRequest', 'RequestedFile', 'Import'],
		 id = 12560611460656617445, scope = 14981803260258615394,
		 src = <<"schema.zap:CodeGeneratorRequest.RequestedFile.Import">>,
		 kind =
...
'15102134695616452902'() ->
    #schema_node{module = schema_zap, name = 'ElementSize', id = 15102134695616452902,
		 scope = 12195682960037147353, src = <<"schema.zap:ElementSize">>,
		 kind =
		     #enum{values =
...
'17422339044421236034'() ->
    #schema_node{module = schema_zap, name = 'Annotation', id = 17422339044421236034,
		 scope = 12195682960037147353, src = <<"schema.zap:Annotation">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = id,
...
'14853958794117909659'() ->
    #schema_node{module = schema_zap, name = 'Value', id = 14853958794117909659,
		 scope = 12195682960037147353, src = <<"schema.zap:Value">>,
		 kind =
...
'15020482145304562784'() ->
    #schema_node{module = schema_zap, name = 'Type', id = 15020482145304562784,
		 scope = 12195682960037147353, src = <<"schema.zap:Type">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite,
			     union_field =
				 #data{type =
...
'17116997365232503999'() ->
    #schema_node{module = schema_zap, name = ['Type', interface], id = 17116997365232503999,
		 scope = 15020482145304562784, src = <<"schema.zap:Type.interface">>,
		 kind =
...
'12410354185295152851'() ->
    #schema_node{module = schema_zap, name = ['Type', struct], id = 12410354185295152851,
		 scope = 15020482145304562784, src = <<"schema.zap:Type.struct">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = typeId,
...
'11389172934837766057'() ->
    #schema_node{module = schema_zap, name = ['Type', enum], id = 11389172934837766057,
		 scope = 15020482145304562784, src = <<"schema.zap:Type.enum">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = typeId,
...
'9792858745991129751'() ->
    #schema_node{module = schema_zap, name = ['Type', list], id = 9792858745991129751,
		 scope = 15020482145304562784, src = <<"schema.zap:Type.list">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
...
'10736806783679155584'() ->
    #schema_node{module = schema_zap, name = 'Method', id = 10736806783679155584,
		 scope = 12195682960037147353, src = <<"schema.zap:Method">>,
		 kind =
...
'10919677598968879693'() ->
    #schema_node{module = schema_zap, name = 'Enumerant', id = 10919677598968879693,
		 scope = 12195682960037147353, src = <<"schema.zap:Enumerant">>,
		 kind =
		     #struct{dsize = 1, psize = 2, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = name, kind = #ptr{type = text, idx = 0, default = <<"">>}},
...
'11145653318641710175'() ->
    #schema_node{module = schema_zap, name = 'Field', id = 11145653318641710175,
		 scope = 12195682960037147353, src = <<"schema.zap:Field">>,
		 kind =
...
'10930602151629473554'() ->
    #schema_node{module = schema_zap, name = ['Field', noDiscriminant], id = 10930602151629473554,
		 scope = 11145653318641710175, src = <<"schema.zap:Field.noDiscriminant">>,
		 kind = #const{field = #data{type = uint16, align = 0, default = <<255, 255>>}}}.

'13515537513213004774'() ->
    #schema_node{module = schema_zap, name = ['Field', ordinal], id = 13515537513213004774,
		 scope = 11145653318641710175, src = <<"schema.zap:Field.ordinal">>,
		 kind =
		     #struct{dsize = 3, psize = 4, esize = inlineComposite,
			     union_field =
				 #data{type =
...
'14626792032033250577'() ->
    #schema_node{module = schema_zap, name = ['Field', group], id = 14626792032033250577,
		 scope = 11145653318641710175, src = <<"schema.zap:Field.group">>,
		 kind =
...
'14133145859926553711'() ->
    #schema_node{module = schema_zap, name = ['Field', slot], id = 14133145859926553711,
		 scope = 11145653318641710175, src = <<"schema.zap:Field.slot">>,
		 kind =
		     #struct{dsize = 3, psize = 4, esize = inlineComposite, union_field = none,
			     fields =
...
'16610026722781537303'() ->
    #schema_node{module = schema_zap, name = 'Node', id = 16610026722781537303,
		 scope = 12195682960037147353, src = <<"schema.zap:Node">>,
		 kind =
...
'16050641862814319170'() ->
    #schema_node{module = schema_zap, name = ['Node', 'NestedNode'], id = 16050641862814319170,
		 scope = 16610026722781537303, src = <<"schema.zap:Node.NestedNode">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = name, kind = #ptr{type = text, idx = 0, default = <<"">>}},
...
'17011813041836786320'() ->
    #schema_node{module = schema_zap, name = ['Node', annotation], id = 17011813041836786320,
		 scope = 16610026722781537303, src = <<"schema.zap:Node.annotation">>,
		 kind =
...
'12793219851699983392'() ->
    #schema_node{module = schema_zap, name = ['Node', const], id = 12793219851699983392,
		 scope = 16610026722781537303, src = <<"schema.zap:Node.const">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = type,
...
'16728431493453586831'() ->
    #schema_node{module = schema_zap, name = ['Node', interface], id = 16728431493453586831,
		 scope = 16610026722781537303, src = <<"schema.zap:Node.interface">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
...
'13063450714778629528'() ->
    #schema_node{module = schema_zap, name = ['Node', enum], id = 13063450714778629528,
		 scope = 16610026722781537303, src = <<"schema.zap:Node.enum">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
...
'11430331134483579957'() ->
    #schema_node{module = schema_zap, name = ['Node', struct], id = 11430331134483579957,
		 scope = 16610026722781537303, src = <<"schema.zap:Node.struct">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
