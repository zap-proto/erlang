...
%% This file was generated 2016-08-18 19:43:19 UTC by ezap 0.2.
...
'12903543124727603792'() ->
    #schema_node{module = rpc_zap, name = root, id = 12903543124727603792, scope = 0,
		 src = <<"rpc.zap">>, annotations = [{13386661402618388268, <<"zap::rpc">>}], kind = file,
		 nodes =
...
'15430940935639230746'() ->
    #schema_node{module = rpc_zap, name = 'Exception', id = 15430940935639230746,
		 scope = 12903543124727603792, src = <<"rpc.zap:Exception">>,
		 kind =
...
'13523986587913222488'() ->
    #schema_node{module = rpc_zap, name = ['Exception', 'Durability'], id = 13523986587913222488,
		 scope = 15430940935639230746, src = <<"rpc.zap:Exception.Durability">>,
...
'15235686326393111165'() ->
    #schema_node{module = rpc_zap, name = 'ThirdPartyCapDescriptor', id = 15235686326393111165,
		 scope = 12903543124727603792, src = <<"rpc.zap:ThirdPartyCapDescriptor">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = id,
...
'14883405629196290303'() ->
    #schema_node{module = rpc_zap, name = 'SturdyRef', id = 14883405629196290303,
		 scope = 12903543124727603792, src = <<"rpc.zap:SturdyRef">>,
		 kind =
...
'15564635848320162976'() ->
    #schema_node{module = rpc_zap, name = 'PromisedAnswer', id = 15564635848320162976,
		 scope = 12903543124727603792, src = <<"rpc.zap:PromisedAnswer">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
...
'17516350820840804481'() ->
    #schema_node{module = rpc_zap, name = ['PromisedAnswer', 'Op'], id = 17516350820840804481,
		 scope = 15564635848320162976, src = <<"rpc.zap:PromisedAnswer.Op">>,
		 kind =
...
'9593755465305995440'() ->
    #schema_node{module = rpc_zap, name = 'CapDescriptor', id = 9593755465305995440,
		 scope = 12903543124727603792, src = <<"rpc.zap:CapDescriptor">>,
		 kind =
...
'11100916931204903995'() ->
    #schema_node{module = rpc_zap, name = 'Payload', id = 11100916931204903995,
		 scope = 12903543124727603792, src = <<"rpc.zap:Payload">>,
		 kind =
		     #struct{dsize = 0, psize = 2, esize = inlineComposite, union_field = none,
			     fields =
...
'10789521159760378817'() ->
    #schema_node{module = rpc_zap, name = 'MessageTarget', id = 10789521159760378817,
		 scope = 12903543124727603792, src = <<"rpc.zap:MessageTarget">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite,
			     union_field =
				 #data{type =
...
'18149955118657700271'() ->
    #schema_node{module = rpc_zap, name = 'Join', id = 18149955118657700271,
		 scope = 12903543124727603792, src = <<"rpc.zap:Join">>,
		 kind =
...
'15332985841292492822'() ->
    #schema_node{module = rpc_zap, name = 'Accept', id = 15332985841292492822,
		 scope = 12903543124727603792, src = <<"rpc.zap:Accept">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = questionId,
...
'11270825879279873114'() ->
    #schema_node{module = rpc_zap, name = 'Provide', id = 11270825879279873114,
		 scope = 12903543124727603792, src = <<"rpc.zap:Provide">>,
		 kind =
		     #struct{dsize = 1, psize = 2, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = questionId,
...
'9666541409743531671'() ->
    #schema_node{module = rpc_zap, name = 'Delete', id = 9666541409743531671,
		 scope = 12903543124727603792, src = <<"rpc.zap:Delete">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = questionId,
...
'17009130564474155176'() ->
    #schema_node{module = rpc_zap, name = 'Restore', id = 17009130564474155176,
		 scope = 12903543124727603792, src = <<"rpc.zap:Restore">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = questionId,
...
'16433336749162137644'() ->
    #schema_node{module = rpc_zap, name = 'Save', id = 16433336749162137644,
		 scope = 12903543124727603792, src = <<"rpc.zap:Save">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = questionId,
...
'17970548384007534353'() ->
    #schema_node{module = rpc_zap, name = 'Disembargo', id = 17970548384007534353,
		 scope = 12903543124727603792, src = <<"rpc.zap:Disembargo">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
...
'15376050949367520589'() ->
    #schema_node{module = rpc_zap, name = ['Disembargo', context], id = 15376050949367520589,
		 scope = 17970548384007534353, src = <<"rpc.zap:Disembargo.context">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite,
			     union_field =
				 #data{type =
...
'12473400923157197975'() ->
    #schema_node{module = rpc_zap, name = 'Release', id = 12473400923157197975,
		 scope = 12903543124727603792, src = <<"rpc.zap:Release">>,
		 kind =
...
'13529541526594062446'() ->
    #schema_node{module = rpc_zap, name = 'Resolve', id = 13529541526594062446,
		 scope = 12903543124727603792, src = <<"rpc.zap:Resolve">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite,
			     union_field =
				 #data{type =
...
'15239388059401719395'() ->
    #schema_node{module = rpc_zap, name = 'Finish', id = 15239388059401719395,
		 scope = 12903543124727603792, src = <<"rpc.zap:Finish">>,
		 kind =
		     #struct{dsize = 1, psize = 0, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{id = 0, name = questionId,
...
'11392333052105676602'() ->
    #schema_node{module = rpc_zap, name = 'Return', id = 11392333052105676602,
		 scope = 12903543124727603792, src = <<"rpc.zap:Return">>,
		 kind =
...
'9469473312751832276'() ->
    #schema_node{module = rpc_zap, name = 'Call', id = 9469473312751832276,
		 scope = 12903543124727603792, src = <<"rpc.zap:Call">>,
		 kind =
...
'15774052265921044377'() ->
    #schema_node{module = rpc_zap, name = ['Call', sendResultsTo], id = 15774052265921044377,
		 scope = 9469473312751832276, src = <<"rpc.zap:Call.sendResultsTo">>,
		 kind =
...
'10500036013887172658'() ->
    #schema_node{module = rpc_zap, name = 'Message', id = 10500036013887172658,
		 scope = 12903543124727603792, src = <<"rpc.zap:Message">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite,
			     union_field =
				 #data{type =
